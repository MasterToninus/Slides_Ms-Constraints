...
{	
	...
	{\vskip 1ex}
	\href{https://www.mat.uniroma2.it/~ricerca/algebr/page-AREA_files/page-AREA-2_files/talks.html}{- ARTS - Algebra and Representation Theory Seminar}
	\\
		...
		\tikz[overlay,remember picture]
		{
	    	...
	    	\node[        
	    		text width = 3.5cm
	        		...
	        		at ($(current page.south west)+(2.0,2.0)$) [rotate=0] {
...
%--------------------------------------------------------------------------------------------------%
	\addtocounter{framenumber}{-1}
		\begin{frame}{Conclusions}
			...
			\begin{claimblocktitle}[Recovered previous reduction procedures]
