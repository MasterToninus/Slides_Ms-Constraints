...
\begin{frame}[shrink]{Constraint $L_\infty$ Algebra Associated with a constraint BV-module}
	...
	A constraint vector space $L=\triple{L}$  equipped with a collection of constraint multilinear maps
	\begin{displaymath}
		l_j \colon L^{\otimes j} \to L[2-j]
	\end{displaymath}
	...
	\begin{defblock}[Constraint vector space of Hamiltonian pairs]\label{def:constraint-algebraicham0}
		The	 constraint graded vector space:
		$$
		\Ham^0(V, \omega) := 
		\colvec{
...
\end{frame}
\note[itemize]{
	\item  This framework provides a unified approach to understanding various geometric and algebraic structures.
}
%- . - . - . - . - . - . - . - . - . - . - . - . - . - . - . - . - . - . - . - . - . - . - . - .%
